...
LISTADE.insertFirst(10);
LISTADE.insertLast(20);
LISTADE.insertAt(15, 1);

// Imprimimos la lista
console.log(LISTADE.print()); 

// Eliminamos algunos elementos
console.log(LISTADE.removeFirst());  
console.log(LISTADE.removeLast()); 

// Imprimimos nuevamente
console.log(LISTADE.print());  

// Probamos eliminar un elemento específico
LISTADE.insertFirst(10);
LISTADE.insertLast(20);
console.log(LISTADE.removeData(15));  
console.log(LISTADE.print()); 

// Probamos eliminar por índice
LISTADE.insertAt(25, 1);
console.log(LISTADE.removeFrom(1));  
console.log(LISTADE.print());  

// Imprimimos en orden inverso
console.log(LISTADE.reversePrint());  

// Verificamos el tamaño de la lista y si está vacía
console.log(LISTADE.getSize());  